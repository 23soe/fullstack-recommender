...
def add_poster(df):
    for i, row in tqdm(df.iterrows(), total=df.shape[0]):
        tmdb_id = row["tmdbId"]
        tmdb_url = f"https://api.themoviedb.org/3/movie{tmdb_id}?api_key=0b590149a3d346ff9c0866d5862270b9&language=en-US"
        ...
        try:
            ...
            df.at[i, "poster_path"] = "https://image.tmdb.org/t/original/uXDfjJbdP4ijW5hWSBrPrlKpxab.jpg"
    return df

if __name__ == "__main__":
    movies_df = pd.read_csv('data/movies.csv')
    #id를 문자로 인식할 수 있도록 type 변경
